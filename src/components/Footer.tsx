    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            <li>
              <button onClick={() => handleNavigation('home')} className="footer-link">Home</button>
            </li>
            <li>
            ...
            <li>
              <button onClick={() => handleNavigation('faq')} className="footer-link">FAQ</button>
            </li>
            <li>
              <button onClick={() => handleNavigation('process')} className="footer-link">How we work</button>
            </li>
            <li>
              <button onClick={() => handleNavigation('work-with-us')} className="footer-link">AI Solutions for</button>
            </li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-container">
          <p className="copyright">© {currentYear} Buiz AI. All rights reserved.</p>
